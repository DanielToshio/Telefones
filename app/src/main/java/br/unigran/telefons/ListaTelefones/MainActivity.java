...
public class MainActivity extends AppCompatActivity {
                    ...
                    public boolean onItemLongClick(AdapterView<?> adapterView,
                        ...
                        mensagem.setNegativeButton("Editar", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                datanascimento.setText(dados.get(i).getDatanascimento().toString());
    ...
    public boolean verificar() {
        ...
        String s3 = datanascimento.getText().toString();
    ...
    public void salvar(View view) {
        if (verificar()) {
            ...
            contato.setDatanascimento(datanascimento.getText().toString());
